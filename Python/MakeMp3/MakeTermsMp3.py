...
GEMINI_KEY_PATH = r"C:\dev\scripts\ScriptsUteis\Python\secret_tokens_keys\google-gemini-key.txt"
CLOUD_TTS_CREDENTIALS = r"C:\dev\scripts\ScriptsUteis\Python\secret_tokens_keys\google-tts.json"
